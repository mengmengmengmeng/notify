 ...
 */
public class ChannelHosted extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.channel_hosted, container, false);
    ...
    public class getChannel extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try{
                ...
                String url = getString(R.string.hosted)+preferences.getString("id","")+"/channels";
